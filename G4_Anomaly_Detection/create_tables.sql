...
CREATE INDEX IF NOT EXISTS idx_ts ON power_consumption(ts);
CREATE INDEX IF NOT EXISTS idx_anomaly ON power_consumption(is_anomaly);
CREATE INDEX IF NOT EXISTS idx_scored_at ON power_consumption(scored_at);
